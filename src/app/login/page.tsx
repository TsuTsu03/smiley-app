        ...
        <div className="flex-1 flex items-center justify-center px-5 py-10">
          <div className="w-full max-w-md">
            ...
            <div className="text-center mt-6 text-xs text-sky-400 space-x-4">
              <Link href="/" className="hover:text-sky-600 transition-colors underline underline-offset-2">
                Back to home
              </Link>
              <Link href="/privacy" className="hover:text-sky-600 transition-colors underline underline-offset-2">
                Privacy
              </Link>
              <Link href="/terms" className="hover:text-sky-600 transition-colors underline underline-offset-2">
                Terms
              </Link>
            </div>
          </div>
