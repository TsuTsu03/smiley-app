  ...
  if (done) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <h2 className="font-display text-2xl text-blue-800 mb-2">Patient Registered!</h2>
        <p className="text-blue-500 text-sm mb-2">
          <strong>{form.fullName}</strong> has been added to the clinic records.
        </p>
        <p className="text-blue-400 text-xs mb-8">
  ...
  return (
    <div className="max-w-2xl">
      ...
      <Card className="p-6 space-y-5">
        <div>
          <h3 className="font-semibold text-blue-700 text-sm uppercase tracking-wide mb-4">Personal Information</h3>
        ...
        <div className="border-t border-blue-50 pt-5">
          <h3 className="font-semibold text-blue-700 text-sm uppercase tracking-wide mb-4">Contact</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="border-t border-blue-50 pt-5">
          <h3 className="font-semibold text-blue-700 text-sm uppercase tracking-wide mb-4">Medical Information</h3>
        ...
        <div className="border-t border-blue-50 pt-5">
          <h3 className="font-semibold text-blue-700 text-sm uppercase tracking-wide mb-4">Emergency Contact</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
