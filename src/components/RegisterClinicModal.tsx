  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-sky-950/30 backdrop-blur-sm p-4">
      <div className="bg-white rounded-3xl shadow-hover w-full max-w-lg overflow-hidden animate-slide-up">
        <div className="bg-gradient-to-r from-sky-600 to-teal-500 p-7 text-white relative">
        ...
        <div className="p-7">
          {step === 3 ? (
            <div className="text-center py-6">
              <CheckCircle2 size={56} className="text-sky-500 mx-auto mb-4" />
              <h3 className="font-display text-2xl text-sky-800 mb-2">You&apos;re all set!</h3>
              <p className="text-sky-600/70 text-sm mb-2">Your clinic portal is ready at:</p>
              <div className="bg-sky-50 border border-sky-100 rounded-xl px-4 py-3 font-mono text-sky-700 text-sm mb-6">
            ...
            <>
              <h3 className="font-semibold text-sky-800 mb-4">Clinic Information</h3>
              ...
              <button
                ...
                className="mt-5 w-full py-3.5 bg-gradient-to-r from-sky-700 to-sky-600 text-white font-semibold rounded-xl shadow-soft hover:opacity-90 transition-opacity disabled:opacity-40"
              >
                Continue
              </button>
            </>
            ...
            <>
              <h3 className="font-semibold text-sky-800 mb-4">Admin Account</h3>
              <div className="space-y-4">
                <div>
